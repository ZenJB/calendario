    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card-small">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input form="criar_aula" type="submit" name="submit" value="Criar" onclick="alert('Marcação efetuada! Aguarde aprovação do administrador')">
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="card">
                    <div class="card-header"><h1>{{ __('Todas as aulas extra') }}</h1></div>
                    <table>
                        <thead>
                        <tr>
                            <th>Titulo</th>
                        ...
                        @if(isset($cadeiras))
                            ...
                            @endforeach
                        @else
                            Não existe nenhuma aula extra marcada
                        @endif
                        </tbody>
                    </table>
                </div>
